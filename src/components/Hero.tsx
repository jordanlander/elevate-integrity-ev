        ...
        <div className="container mx-auto px-4 py-20">
          <div className="max-w-5xl mx-auto text-center text-white">
            ...
            <div className="flex justify-center gap-3 mb-6 flex-wrap fade-in-up">
              ...
              <Badge className="bg-gradient-to-r from-red-500/90 to-red-700/90 text-white border-2 border-red-400/50 hover:from-red-400 hover:to-red-600 transition-all backdrop-blur-sm px-4 py-2 font-semibold shadow-lg">
            ...
            <div className="fade-in-up" style={{animationDelay: '0.5s'}}>
              <p className="text-xl md:text-2xl mb-10 text-white max-w-4xl mx-auto leading-relaxed">
                Georgia homeowners trust us for EV chargers, Tesla Powerwall, generators, panel upgrades & full electrical services — done right the first time.
              </p>
            </div>
